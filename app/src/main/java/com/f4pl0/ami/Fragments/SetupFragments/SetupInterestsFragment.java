...
public class SetupInterestsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Kunst",Kunst));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Technologie",Technologie));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Natur",Natur));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Essen und Getränke",EssenUndGetranke));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Reisen",Reisen));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Musik",Musik));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Filme und Serien",FilmeUndSerien));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Sport",Sport));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Videospiele / Gaming",Videospiele));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Bücher / Literatur",Bucher));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Wissen",Wissen));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Gesundheit",Gesundheit));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Unterhaltung und Freizeit",Unterhaltung));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Wirtschaft",Wirtschaft));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Veranstaltungen",Veranstaltungen));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Fahrzeuge / Transport",Fahrzeuge));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Beziehungen",Beziehungen));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Kultur und Gesellschaft",Kultur));
        fragmentTransaction.commit ();

        fragmentTransaction = fragmentManager.beginTransaction ()
                .add (R.id.interestCategoryContainerLyt, new SetupInterestsFragmentCategory("Selbstentwicklung",Selbstentwicklung));
        fragmentTransaction.commit ();
